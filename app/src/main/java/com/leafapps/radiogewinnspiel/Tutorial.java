...
*/
    ...
    public void onClick(View v) {
        ...
        getSharedPreferences("PREFERENCE", MODE_PRIVATE)
                .edit()
                //true setzen wenn der einmalige screen immer angezeigt werden soll
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (bundle == null) {
                ...
                switch (bundle.getInt(ARG_SECTION_NUMBER)) {
                    case 1:
                        rootView = inflater.inflate(R.layout.fragment_tutorial, container, false);
                        break;
                    case 2:
            ...
            //savedInstanceState.getInt(ARG_SECTION_NUMBER, 1);
            return rootView;
        }
    }
